      ...
      <Container className="flex flex-col-reverse items-center gap-20 py-20 md:flex-row md:items-start xl:gap-40">
        <div className="flex flex-col justify-between flex-1 w-full overflow-hidden">
          <div>
            ...
            <p className="h-64 mt-1 overflow-hidden text-base text-center break-words md:text-left text-white p-5 ">
          ...
          <div className="mt-2 text-center md:text-left">
            <h4 className="text-lg mb--5 font-bold text-white p-5">Mr.V. Manivannan</h4>
            <p className="text-sm mt--5 text-gray-400 p-5">President 2019/20</p>
          </div>
        </div>
